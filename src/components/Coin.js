    ...
    return (
        <li className = {styles.coin}>
            ...
            <div className = {styles['rank-group']}>
                ...
                > 
                {
                    !inWatchList ? <AiOutlineStar /> :
                    <AiFillStar className = {styles['watchlist-added']} /> 
                }
            ...
            <span> {coinsCtx.currencySymbol} { addComma(price) } </span>

            <span className = {styles.supply} > {supply ? addComma(supply) : `∞` } </span>

            <span className = {styles['market-cap']}> {coinsCtx.currencySymbol} { addComma(marketCap) } </span>
